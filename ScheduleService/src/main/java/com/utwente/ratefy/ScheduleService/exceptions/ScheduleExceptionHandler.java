package com.utwente.ratefy.ScheduleService.exceptions;
...
public class ScheduleExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  private static final Logger local_logger = LoggerFactory.getLogger(ScheduleExceptionHandler.class);
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    return getExceptionResponseEntity(
        exception, status, request, Collections.singletonList(exception.getLocalizedMessage()));
  }
